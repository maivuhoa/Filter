...
public class MyTicketPage extends GeneralPage {
    ...
    private final By txtErrorMess = By.xpath("//div[@class='error message']");
    //Element
    ...
    private WebElement getTxtErrorMess(){return Constant.WEBDRIVER.findElement(txtErrorMess);}
    //Method
    ...
    public boolean isMatchDate(){
        return getTxtErrorMess().isDisplayed();
    }
}
